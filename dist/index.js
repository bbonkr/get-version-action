...
exports.getVersion = exports.getVersionFromCsproj = exports.getVersionFromPackageJson = void 0;
const core = __importStar(__nccwpck_require__(2186));
const fs = __importStar(__nccwpck_require__(3292));
const path = __importStar(__nccwpck_require__(1017));
const xmldom_1 = __importDefault(__nccwpck_require__(9213));
const xpath_1 = __importDefault(__nccwpck_require__(5319));
const getVersionFromPackageJson = (content) => {
    const packageJson = JSON.parse(content);
    const version = packageJson['version'];
    return version !== null && version !== void 0 ? version : '';
};
exports.getVersionFromPackageJson = getVersionFromPackageJson;
const getVersionFromCsproj = (content) => {
    var _a;
...
const getVersion = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (extname) {
        case '.json':
            version = (0, exports.getVersionFromPackageJson)(content);
            break;
        case '.csproj':
            version = (0, exports.getVersionFromCsproj)(content);
            break;
        default:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const getVersion_1 = __nccwpck_require__(2936);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                const version = (0, version_1.parseVersion)(result);
                if (version) {
                    core.setOutput(outputs_1.outputs.major, version.major);
                    core.setOutput(outputs_1.outputs.minor, version.minor);
                    core.setOutput(outputs_1.outputs.patch, version.patch);
                    core.setOutput(outputs_1.outputs.preRelease, version.preRelease);
                    core.setOutput(outputs_1.outputs.build, version.build);
                }
            }
            catch (err) {
                // do nothing
